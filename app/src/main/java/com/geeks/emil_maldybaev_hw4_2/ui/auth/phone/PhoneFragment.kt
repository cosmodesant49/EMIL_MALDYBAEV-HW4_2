package com.geeks.emil_maldybaev_hw4_2.ui.auth.phone
...
import com.geeks.emil_maldybaev_hw4_2.databinding.FragmentPhoneBinding
...
class PhoneFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnSend.setOnClickListener {
            val number="${binding.tilPhone.prefixText.toString()}${binding.etPhone.text.toString()}"
